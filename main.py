...
ADMIN_UID = "3085763766"
server2 = "BD"
key2 = "mg24"
BYPASS_TOKEN = "your_bypass_token_here"
WHITELIST_ONLY = False
bot_enabled = True
BOT_OWNER_UID = 3085763766 
PLAYER_NAME_CACHE = {}  
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]NoTmeowL [00FF00]___ XPM BOT ! \n[FFD700]⚡NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @maim_ff\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ WELCOME TO XPM MAIM ░░▒▓█
[00FF00]»»————-　★　————-««
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]XPM MAIM !! 
[FFD700]✨ Name on instagram : [FFFFFF]Maim bro❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> XPM MAIM  ⚡
"""
...
[FFD700]━━━━━━━━━━━━'''
    ...
    # ───── Commands 11-20 ─────
                            help_2 = '''[C][B][FFD700]═══⚓︎ XPM MAIM | HELP 2/6 ⚓︎═══[00FF00][B]
...
[FFD700]━━━━━━━━━━━━
    ...
    # ───── Commands 21-30 ─────
                            help_3 = '''[C][B][FFD700]═══⚓︎ XPM MAIM BOT | HELP 3/6 ⚓︎═══[00FF00][B]
...
[FFD700]━━━━━━━━━━━━'''
    ...
    # ───── Commands 31-40 ─────
                            help_4 = '''[C][B][FFD700]═══⚓︎ XPM  BOT | HELP 4/6 ⚓︎═══[00FF00][B]
...
[FFD700]━━━━━━━━━━━━'''
    ...
    # ───── Commands 41-50 ─────
                            help_5 = '''[C][B][FFD700]═══⚓︎ XPM MAIM BOT | HELP 5/6 ⚓︎═══[00FF00][B]
...
[FFD700]━━━━━━━━━━━━'''
    ...
    # ───── Commands 51-62 ─────
                            help_6 = '''[C][B][FFD700]═══⚓︎ XPM MAIM | HELP 6/6 ⚓︎═══[00FF00][B]
